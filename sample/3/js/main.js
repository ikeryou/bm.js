(function() {
  ...
  root.MY_CLASS.graphicView = (function(_super) {
    ...
    function graphicView() {
      this._setBlendMode = __bind(this._setBlendMode, this);
      this.update = __bind(this.update, this);
      this.resize = __bind(this.resize, this);
      this.dispose2 = __bind(this.dispose2, this);
      ...
      this._imgData[1] = new root._LIBS.image(root.MY.conf.PATH_IMG + "mask.png", this._imgData[0].width, this._imgData[0].height);
    }
    ...
    graphicView.prototype.addStage = function() {
      ...
      this._imgData[0].onMakeData = function() {
        ...
        _this._imgData[1].onMakeData = function() {
          _this._topCanvas = new root._LIBS.display(_this.id() + "_topCanvas", {
            update: false,
            resize: false
          });
          _this.addChild(_this._topCanvas);
          _this._topCanvas.size(_this._imgData[1].width, _this._imgData[1].height);
          _this._topCanvas.canvas();
          _this._topCanvas.ctx().drawImage(_this._imgData[1].data(), 0, 0);
          _this._topCanvas.elm().hide();
          return _this._setBlendMode();
        };
        return _this._imgData[1].makeData();
      };
    ...
    graphicView.prototype._setBlendMode = function() {
      var bmjs;
      ...
      this._outputCanvas.size(this._imgData[1].width, this._imgData[1].height);
      this._outputCanvas.canvas();
      bmjs = new bm();
      return bmjs.apply(this._bgCanvas.canvasId(), this._topCanvas.canvasId(), this._outputCanvas.canvasId(), bmjs.ALPHA);
    };
