(function() {
  ...
  root.MY_CLASS.contentsView = (function(_super) {
    ...
    contentsView.prototype.addStage = function() {
      ...
      this._topLayer.init();
      this._canvas = new root.MY_CLASS.canvasView();
      return this.addChild(this._canvas);
    };
  ...
  root.MY_CLASS.canvasView = (function(_super) {
    __extends(canvasView, _super);

    function canvasView() {
      this._setRain = __bind(this._setRain, this);
      this._eLoadedImg2 = __bind(this._eLoadedImg2, this);
      this._eLoadedImg = __bind(this._eLoadedImg, this);
      this.update = __bind(this.update, this);
      this.resize = __bind(this.resize, this);
      this.dispose2 = __bind(this.dispose2, this);
      canvasView.__super__.constructor.call(this, "canvasView");
      this._bg;
      this._rain;
      this._imgData[0] = new root._LIBS.image(root.MY.conf.PATH_IMG + "photo.jpg", 800, 450);
      this._imgData[1] = new root._LIBS.image(root.MY.conf.PATH_IMG + "photo2.jpg", this._imgData[0].width, this._imgData[0].height);
      this._cnt = 0;
    }

    canvasView.prototype.addStage = function() {
      this.size(this._imgData[0].width, this._imgData[0].height);
      this._imgData[0].onMakeData = this._eLoadedImg;
      return this._imgData[0].makeData();
    };

    canvasView.prototype.dispose2 = function() {};
    ...
    canvasView.prototype._eLoadedImg = function() {
      this._imgData[1].onMakeData = this._eLoadedImg2;
      return this._imgData[1].makeData();
    };

    canvasView.prototype._eLoadedImg2 = function() {
      return this._setRain();
    };

    canvasView.prototype._setRain = function() {
      if (this._bg != null) {
        this._bg.dispose();
        this._bg = null;
      }
      ...
      this._bg = new root._LIBS.display(this.id() + "_bg", {
        resize: false,
        update: false
      });
      this.addChild(this._bg);
      this._bg.setImg(this._imgData[0]);
      this._rain = new root.MY_CLASS.rainView(this._imgData[0], this._imgData[1]);
      return this.addChild(this._rain);
    };
  ...
  root.MY_CLASS.rainView = (function(_super) {
    __extends(rainView, _super);

    function rainView(imgData, imgData2) {
      this._eLoadedImg = __bind(this._eLoadedImg, this);
      this.update = __bind(this.update, this);
      this.resize = __bind(this.resize, this);
      this.dispose2 = __bind(this.dispose2, this);
      rainView.__super__.constructor.call(this, "rainView");
      this._img = imgData;
      this._img2 = imgData2;
      this._topCanvas;
      this._parts = [];
    ...
    rainView.prototype.addStage = function() {
      var ctx, i, p;
      ...
      this._topCanvas.size(this._img.width, this._img.height);
      this._topCanvas.canvas();
      ctx = this._topCanvas.ctx();
      ctx.drawImage(this._img.data(), 0, 0);
      this._topCanvas.elm().hide();
      i = 0;
      while (i < 20) {
        p = new root.MY_CLASS.rainParts(this.id() + "_parts" + i, this._img, this._img2, this._topCanvas.canvasId());
        this.addChild(p);
        this._parts.push(p);
        i++;
      }
    ...
    rainView.prototype.dispose2 = function() {
      var i, val, _i, _len, _ref;
      if (this._parts != null) {
        _ref = this._parts;
        for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
      ...
      if (this._topCanvas != null) {
        this._topCanvas.dispose();
        this._topCanvas = null;
      }
      this._img = null;
      return this._img2 = null;
    };

    rainView.prototype.resize = function() {
      var h, w;
      w = root.MY.main.ws.w;
      return h = root.MY.main.ws.h;
    };

    rainView.prototype.update = function() {
      var cx, cy, dx, dy, i, m, mx, my, rot, u, val, _i, _len, _ref, _results;
      u = root.MY.util;
      m = this.mouse();
      mx = m.x;
      my = m.y;
      cx = root.MY.main.ws.w * 0.5;
      cy = root.MY.main.ws.h * 0.5;
      dx = mx - cx;
      dy = my - cy;
      rot = u.degree(Math.atan2(dy, dx));
      _ref = this._parts;
      _results = [];
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        val = _ref[i];
        _results.push(val.setRot(rot, dx * 0.01));
      }
      return _results;
    };

    rainView.prototype._eLoadedImg = function() {};

    return rainView;

  })(root._LIBS.display);

  root.MY_CLASS.rainParts = (function(_super) {
    __extends(rainParts, _super);

    function rainParts(elm, imgData, baseImg, applyCanvasId) {
      ...
      this.setRot = __bind(this.setRot, this);
      this._updatePara = __bind(this._updatePara, this);
      this.reset = __bind(this.reset, this);
      this.update = __bind(this.update, this);
      this.dispose2 = __bind(this.dispose2, this);
      rainParts.__super__.constructor.call(this, elm, {
        update: true,
        resize: false
      });
      this._img = imgData;
    ...
    rainParts.prototype.addStage = function() {
      var u;
      u = root.MY.util;
      ...
      this._output.canvas();
      this.mask();
      this._setBaseCanvas(root.MY.util.getRandomColor());
      this._setBlend();
      this.reset();
      return this._updateTransform();
    };

    rainParts.prototype.dispose2 = function() {
    ...
    rainParts.prototype.update = function() {};

    rainParts.prototype.reset = function() {
      var u;
      u = root.MY.util;
      this._p.width = u.random(20, 100);
      this._p.height = this._p.width;
      this.size(this._p.width, this._p.height);
      this._p.x = u.random(0, this._img.width);
      this._p.y = -(this._p.height + u.random(0, this._img.height));
      this._p.c = u.random(50, 330) / 100;
      this._p.speedY = u.random(200, 400) / 100;
      return this._p.speedYAdd = u.random(5, 20) / 100;
    };

    rainParts.prototype._updatePara = function() {
      this._p.speedY += this._p.speedYAdd;
      this._p.y += this._p.speedY;
      this._p.x += this._p.speedX;
      if (this._p.y > this._output.height() + this._p.height) {
        return this.reset();
      }
    };

    rainParts.prototype.setRot = function(rot, speedX) {
      var u;
      u = root.MY.util;
      rot *= this._p.c;
      this._p.rot += (rot - this._p.rot) * 0.1;
      speedX *= this._p.c;
      this._p.speedX += (speedX - this._p.speedX) * 0.1;
      this._updatePara();
      return this._updateTransform();
    };

    rainParts.prototype._updateTransform = function() {
      var u;
      u = root.MY.util;
    ...
    rainParts.prototype._setBaseCanvas = function(color) {
      var ctx;
      if (this._baseCanvas == null) {
      ...
      ctx.drawImage(this._img2.data(), 0, 0);
      return this._baseCanvas.elm().hide();
    };

    rainParts.prototype._setBlend = function() {
      var arr, bmobj;
      bmobj = new bm();
      ...
      return bmobj.apply(this._baseCanvas.canvasId(), this._applyCanvasId, this._output.canvasId(), arr[root.MY.util.random(0, arr.length - 1)]);
    };
